package edu.department.employment.infosys.jazzyviewpager;
...
public class JazzyViewPager extends ViewPager {
	...
	private void resetPrivate() {
		...
		//Log.v("jazzy", "resetprivate finish");
	}
	...
	public void onPageScrolled(int position, float positionOffset,
		...
		float effectOffset = isSmall(positionOffset) ? 1 : positionOffset;
