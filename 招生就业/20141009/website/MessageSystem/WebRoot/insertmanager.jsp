	...
	<div id="forms" class="mt10">
        <div class="box">
          <div class="box_border">
            <div class="box_top"><b class="pl15">插入管理员信息</b></div>
              ...
              <form action="manager" class="jqtransform">
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                 <tr>
                  ...
                  <td class=""> 
                    <input type="text" name="manager.managerID" class="input-text lh30" size="50">
                  </td>
                 </tr>
                 <tr>
                  <td class="td_right">姓名：</td>
                  <td class="">
                    <input type="text" name="manager.managerName" class="input-text lh30" size="50">
                  </td>
                 </tr>
                 <tr>
                  <td class="td_right">证件：</td>
                  <td class=""> 
                    <input type="text" name="manager.managerIDCard" class="input-text lh30" size="50">
                  </td>
                 </tr>
                 <tr>
                 ...
                 <tr>
                  ...
                  <td class=""> 
                    <input type="text" name="manager.managerPhone" class="input-text lh30" size="50" maxlength="15">
                  </td>
                </tr>
                <tr>
                  <td class="td_right">邮箱：</td>
                  <td class=""> 
                    <input type="text" name="manager.managerEmail" class="input-text lh30" size="50">
                  </td>
                </tr>
                 <tr>
