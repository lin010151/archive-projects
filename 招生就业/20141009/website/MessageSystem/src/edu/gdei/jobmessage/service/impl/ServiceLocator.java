...
public class ServiceLocator {
	...
	public static String MESSAGE_SERVICE = "pushmessageService";
	...
	public static IUserService getUserService() {
		return (IUserService) XmppServer.getInstance().getBean(USER_SERVICE);
	}

	/**
	 * Obtains the pushmessage service.
	 * 
	 * @return the pushmessage service.
	 */
	public static IPushMessageService getPushMessageService() {
		return (IPushMessageService) XmppServer.getInstance().getBean(
				MESSAGE_SERVICE);
	}
