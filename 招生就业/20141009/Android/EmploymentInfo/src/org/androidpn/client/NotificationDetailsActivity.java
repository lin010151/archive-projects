...
import edu.department.employment.infosys.gui.DetailRecruitinfoActivity;
...
public class NotificationDetailsActivity extends Activity {
    ...
    private View createView(final String title, final String message,
        ...
        okButton.setText("查看详细信息");
        okButton.setWidth(300);

        okButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent();
				intent.setClass(NotificationDetailsActivity.this, DetailRecruitinfoActivity.class);
