...
public class NotificationSettingsActivity extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (notifyPref.isChecked()) {
            notifyPref.setTitle("允许通知");
        } else {
            notifyPref.setTitle("禁止通知");
        }
    }
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        notifyPref.setTitle("允许通知");
        notifyPref.setSummaryOn("接收通知");
        notifyPref.setSummaryOff("不接收通知");
        ...
        notifyPref
                .setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                    public boolean onPreferenceChange(Preference preference,
                        ...
                        if (checked) {
                            preference.setTitle("允许通知");
                        } else {
                            preference.setTitle("禁止通知");
                        }
                        return true;
                    }
                });
        ...
        soundPref.setSummaryOn("允许声音");
        soundPref.setSummaryOff("禁止声音");
        ...
        vibratePref.setSummaryOn("允许震动");
        vibratePref.setSummaryOff("禁止震动");
