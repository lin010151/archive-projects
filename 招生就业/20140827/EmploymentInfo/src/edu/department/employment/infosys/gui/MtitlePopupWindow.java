...
public class MtitlePopupWindow extends PopupWindow {
	...
	private void initView(){
		...
		View popupView = inflater.inflate(R.layout.setting_popupwindow, null);
		...
		adapter = new ArrayAdapter<String>(mContext, R.layout.popupwindow_item, R.id.popup_item, list);
